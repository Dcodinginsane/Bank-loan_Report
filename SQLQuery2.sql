...
-- Here is the list of all SQL queries categorized as described:
...
-- 2. **State Overview**
   SELECT 
       ...
       COUNT(id) AS Total_Loan_Applications,
       SUM(loan_amount) AS Total_Funded_A
...
SELECT 
    ...
    COUNT(id) AS Total_Loan_Applications,
    SUM(loan_amount) AS Total_Funded_Amount,
    SUM(total_payment) AS Total_Amount_Received  -- Assuming total_payment is correct
FROM bank_loan_data
